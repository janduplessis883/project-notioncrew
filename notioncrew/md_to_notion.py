...
def create_new_notion_page(cpms_id):
    ...
    response = nh.new_page_to_db("16bfdfd68a978047b47dfe063a6a5407", page_properties=properties)
    return response['id']
...
if __name__ == "__main__":
    ...
    md_files = ["01_the_study.md", "02_site_profile.md", "03_site_identification_questions.md", "04_submission_audit.md"]
